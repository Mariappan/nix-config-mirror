  ...
  flake.modules.nixos.boot = { config, lib, pkgs, ... }:
    ...
    in {
      options.nixma.nixos.boot = {
        ...
        limine = {
          maxGenerations = lib.mkOption {
            ...
            default = 10;
            description = "Maximum number of generations in the Limine boot menu. null means no limit.";
          };
          ...
          interfaceResolution = lib.mkOption {
            type = lib.types.nullOr lib.types.str;
            default = null;
            example = "2560x1440";
            description = "Resolution of the Limine bootloader menu interface.";
          };

          extraEntries = lib.mkOption {
            type = lib.types.lines;
            default = "";
            description = "Extra entries appended to limine.conf.";
          };
        };
      ...
      config = {
        ...
        boot.loader.limine = lib.mkIf (cfg.bootloader == "limine") {
          enable = true;
          maxGenerations = cfg.limine.maxGenerations;
          resolution = cfg.limine.resolution;
          style.interface.resolution = cfg.limine.interfaceResolution;
